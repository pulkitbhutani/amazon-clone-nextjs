  ...
  return (
    <header>
      ...
      <div className="flex items-center bg-amazon_blue p-1 flex-grow py-2">
        ...
        {/*Search Bar*/}
        <div className="hidden sm:flex items-center h-10 rounded-md flex-grow bg-yellow-400 hover:bg-yellow-500 cursor-pointer focus:outline-none">
          <input
